class Tidyup {
  ...
  afterDraw(chart, args, plugin) {
    ...
    if (container === null) {
      ...
      buttonAsc.innerHTML = plugin.asc?.button?.label ?? "<i class='bx bx-trending-up' style='font-size: 24px;'></i>";
      ...
      buttonDesc.innerHTML = plugin.desc?.button?.label ?? "<i class='bx bx-trending-down' style='font-size: 24px;'></i>";
      ...
      buttonReset.innerHTML = plugin.reset?.button?.label ?? "<i class='bx bx-reset' style='font-size: 24px;'></i>";
